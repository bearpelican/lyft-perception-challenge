...
# model_path = str(Path.cwd()/'600urn-19-weights.h5')
model_path = str(Path.cwd()/'600urn-49_19-384-test-sync.h5')
# model_path = str(Path.cwd()/'600urn-48_f1-384-test-sync-2.h5')
